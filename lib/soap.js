...
exports.listenV2 = exports.listen = exports.createClientAsync = exports.createClient = exports.security = void 0;
...
__createBinding(exports, security_1, "WSSecurityPlusCert");
...
function listenV2(values) {
    ...
    return new server_1.Server(values.server, values.path, values.services, new wsdl_1.WSDL(values.wsdl, '', options), options);
}
exports.listenV2 = listenV2;
