...
var WSSecurityCert = /** @class */ (function () {
    function WSSecurityCert(privatePEM, publicP12PEM, password, options) {
        ...
        this.publicP12PEM = publicP12PEM.toString()
            ...
            .replace(/(\r\n|\n|\r)/gm, '');
        this.signer = new xml_crypto_1.SignedXml((_a = options === null || options === void 0 ? void 0 : options.signerOptions) === null || _a === void 0 ? void 0 : _a.idMode);
    ...
    WSSecurityCert.prototype.postProcess = function (xml, envelopeKey) {
        ...
        var binarySecurityToken = "<wsse:BinarySecurityToken " +
            ...
            timestampStr;
        var xmlWithSec;
        var secExt = "xmlns:wsse=\"" + oasisBaseUri + "/oasis-200401-wss-wssecurity-secext-1.0.xsd\"";
        var secUtility = "xmlns:wsu=\"" + oasisBaseUri + "/oasis-200401-wss-wssecurity-utility-1.0.xsd\"";
        var endOfSecurityHeader = xml.indexOf('</wsse:Security>');
        if (endOfSecurityHeader > -1) {
            var securityHeaderRegexp = /<wsse:Security( [^>]*)?>/;
            var match = xml.match(securityHeaderRegexp);
            var insertHeaderAttributes = '';
            ...
            var headerMarker = '<wsse:Security ';
            var startOfSecurityHeader = xml.indexOf(headerMarker);
            ...
            var secHeader = "<wsse:Security " + secExt + " " +
                secUtility +
        ...
        var originalXmlWithIds = this.signer.getOriginalXmlWithIds();
        var signatureXml = this.signer.getSignatureXml();
